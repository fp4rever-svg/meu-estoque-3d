...
with st.container():
    ...
    aa = col_a2.number_input("Altura A (cm)", min_value=1.0, value=40.0)
    pa = col_a3.number_input("Profundidade A (cm)", min_value=1.0, value=40.0)
    ...
    ab = col_b2.number_input("Altura B (cm)", min_value=0.1, value=5.0)
    pb = col_b3.number_input("Profundidade B (cm)", min_value=0.1, value=3.0)
